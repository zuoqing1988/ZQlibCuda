#ifndef _ZQ_CUDA_POISSON_SOLVER_3D_OPENOCTREEPOISSON_CUH_
#define _ZQ_CUDA_POISSON_SOLVER_3D_OPENOCTREEPOISSON_CUH_
...
namespace ZQ_CUDA_PoissonSolver3D
{
	...
	__global__
	void Adjust_MAC_w_OpenOctreePoisson_Kernel(float* mac_w, const float* p_level0, const float* p_level1, const float* p_level2, const float* p_level3, const bool* leaf0,
														const bool* leaf1, const bool* leaf2, const bool* leaf3, const int width, const int height, const int depth);
	
														
	__global__
	void Calculate_Divergence_Octree_from_previous_level_Kernel(float* cur_level_divergence, const float* pre_level_divergence, const int cur_level_width, const int cur_level_height, const int cur_level_depth);
